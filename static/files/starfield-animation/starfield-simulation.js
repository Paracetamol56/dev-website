...
var wasmBinaryFile;
wasmBinaryFile = 'starfield-simulation.wasm';
...
var ASM_CONSTS = {
	...
	20318: () => document.getElementById('canvas').width,
	20370: () => parseInt(document.getElementById('canvas').style.width),
	20438: () => {
	...
	20584: () => document.getElementById('canvas').width,
	20636: () => screen.width,
	20661: () => {
		document.exitFullscreen();
	},
	...
	20867: () => document.getElementById('canvas').width,
	20919: () => parseInt(document.getElementById('canvas').style.width),
	20987: () => {
		if (document.fullscreenElement) return 1;
	},
	21033: () => document.getElementById('canvas').width,
	21085: () => screen.width,
	21110: () => {
		if (document.fullscreenElement) return 1;
	},
	21156: () => document.getElementById('canvas').width,
	21208: () => screen.width,
	21233: () => {
		document.exitFullscreen();
	},
	...
	21306: () => document.getElementById('canvas').width,
	21358: () => parseInt(document.getElementById('canvas').style.width),
	21426: () => {
		document.exitFullscreen();
	},
	21453: () => screen.width,
	21478: () => screen.height,
	21504: () => window.screenX,
	21531: () => window.screenY,
	21558: ($0) => {
...
var preloadedAudios = {};
var wasmImports = {
	za: GetWindowInnerHeight,
	Aa: GetWindowInnerWidth,
	p: ___assert_fail,
	...
	Md: _emscripten_glActiveTexture,
	Ld: _emscripten_glAttachShader,
	ae: _emscripten_glBeginQueryEXT,
	...
	Ud: _emscripten_glBindVertexArrayOES,
	...
	ce: _emscripten_glDeleteQueriesEXT,
	...
	$c: _emscripten_glDetachShader,
	_c: _emscripten_glDisable,
	Zc: _emscripten_glDisableVertexAttribArray,
	Yc: _emscripten_glDrawArrays,
	Pd: _emscripten_glDrawArraysInstancedANGLE,
	Qd: _emscripten_glDrawBuffersWEBGL,
	Xc: _emscripten_glDrawElements,
	Od: _emscripten_glDrawElementsInstancedANGLE,
	Wc: _emscripten_glEnable,
	Vc: _emscripten_glEnableVertexAttribArray,
	$d: _emscripten_glEndQueryEXT,
	Uc: _emscripten_glFinish,
	...
	Wd: _emscripten_glGetQueryObjecti64vEXT,
	Yd: _emscripten_glGetQueryObjectivEXT,
	Vd: _emscripten_glGetQueryObjectui64vEXT,
	Xd: _emscripten_glGetQueryObjectuivEXT,
	Zd: _emscripten_glGetQueryivEXT,
	...
	_d: _emscripten_glQueryCounterEXT,
	...
	Nd: _emscripten_glVertexAttribDivisorANGLE,
	...
	v: _glViewport,
	x: _glfwCreateWindow,
	ra: _glfwDefaultWindowHints,
	Q: _glfwDestroyWindow,
	y: _glfwGetPrimaryMonitor,
	b: _glfwGetTime,
	qa: _glfwGetVideoModes,
	sa: _glfwInit,
...
var ___errno_location = () => (___errno_location = wasmExports['ke'])();
var ___start_em_js = (Module['___start_em_js'] = 21903);
var ___stop_em_js = (Module['___stop_em_js'] = 21976);
var calledRun;
