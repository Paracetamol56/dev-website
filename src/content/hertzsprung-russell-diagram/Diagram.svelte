...
<div class="relative container h-screen mx-auto" bind:clientWidth={containerWidth} bind:clientHeight={containerHeight}>
	<svg
		id="plot"
	...
	>
		...
		<text dy="12" text-anchor="middle" transform="translate({(margin.left + width - margin.right) / 2}, {margin.top})">
			<tspan fill-opacity="0.8">← hotter&nbsp; </tspan>
			<tspan font-weight="bold">&nbsp;Temperature K&nbsp;</tspan>
			<tspan fill-opacity="0.8">&nbsp;colder → </tspan>
		</text>
		<text dy="-6" text-anchor="middle" transform="translate({(margin.left + width - margin.right) / 2}, {height - margin.bottom})">
