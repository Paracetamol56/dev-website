...
<div class="flex flex-col justify-center items-center">
	<svg width={size} height={size}>
		<g transform="translate(0, 0)">
			<circle
				...
				cy={halfSize}
				r={cohesionRadius}
				class="fill-ctp-lavender/25 stroke-none"
			/>
			<circle
				cx={halfSize}
				cy={halfSize}
	...
	<div class="grow-0 flex flex-row flex-wrap justify-center gap-2">
		<div class="flex gap-1 items-baseline">
			<div class="square-3 rounded-full bg-ctp-lavender/25" />
			<span class="text-ctp-text font-semibold text-sm">Cohesion</span>
		</div>
		<div class="flex">
			<div class="flex gap-1 items-baseline">
				<div class="square-3 rounded-full bg-ctp-lavender/40" />
				<span class="text-ctp-text font-semibold text-sm">Alignment</span>
			</div>
		</div>
		<div class="flex">
			<div class="flex gap-1 items-baseline">
				<div class="square-3 rounded-full bg-ctp-lavender/60" />
