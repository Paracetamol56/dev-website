...
<main class="grid min-h-full place-items-center px-6 lg:px-8">
	<div class="container">
		<div class="text-center">
			...
			<h1 class="mt-4 text-3xl font-bold tracking-tight text-ctp-text sm:text-5xl">
				{$page.error?.message}
			</h1>
...
（ﾟ､ ｡７
 ...
 じしf_, )ノ
			...
			<div class="mt-10 flex items-center justify-center gap-x-6">
				...
				<a
					href="/contact"
					class="flex justify-center items-center text-sm font-semibold text-ctp-text"
					>Contact support&nbsp;<ArrowRight size="16" /></a
				>
			</div>
		</div>
	</div>
