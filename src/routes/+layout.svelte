...
<body class="ctp-{$theme} bg-ctp-base text-ctp-text">
	...
	<nav
		...
		use:melt={$root}
	>
		<div class="flex items-center gap-4 rounded-md bg-ctp-surface0 p-3 text-ctp-text">
			<a href="/">
			...
			<div class="flex items-center gap-2" >
				<a href="/" class="" use:melt={$link}>Link1</a>
				<a href="/" class="" use:melt={$link}>Link2</a>
				<a href="/" class="" use:melt={$link}>Link3</a>
				<a href="/" class="" use:melt={$link}>Link4</a>
			</div>
